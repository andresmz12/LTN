      ...
      <div className="flex gap-2 mb-8">
        {TAB_CONFIG.map((t) => (
          <button
            ...
            style={
              tab === t.id
                ? { background: '#F96167', color: 'white', borderColor: '#F96167' }
    ...
    <div className="max-w-2xl">
      <div className="flex gap-3 mb-6">
        ...
        <button
          ...
          style={{ background: '#E8A33D', color: '#1a1a1a' }}
        >
          🤖 Generar con IA
        </button>
      </div>
      ...
      {editData && !loading && (
        <div className="bg-white rounded-2xl shadow-sm p-6 space-y-4 border-2" style={{ borderColor: '#E8A33D' }}>
          ...
          {(['nombre', 'ciudad', 'estado', 'direccion', 'telefono', 'email', 'horario', 'sitioWeb'] as string[]).map((field) => (
            <div key={field}>
              ...
              <input
                ...
                style={{ '--tw-ring-color': '#E8A33D' } as any}
              />
            </div>
          ))}
          <div>
  ...
  return (
    <div className="max-w-2xl">
      ...
      <div className="space-y-4">
        {noticias.map((n, idx) => (
          <div key={idx} className="bg-white rounded-2xl shadow-sm p-6 space-y-3 border-2" style={{ borderColor: '#E8A33D' }}>
            <div>
